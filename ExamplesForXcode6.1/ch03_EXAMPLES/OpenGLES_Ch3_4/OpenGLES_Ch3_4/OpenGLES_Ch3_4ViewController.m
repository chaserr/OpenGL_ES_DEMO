...
- (void)viewDidLoad
{
   ...
   CGImageRef imageRef1 = 
    ...
    /**
     GLKTextureLoaderOriginBottomLeft:YES 是为了命令 GLKit 的 GLKTextureLoader 类垂直翻转图像数据，这个翻转可以抵消图像的原点和 OpenGL ES 标准原点之间的差异
     */
...
{   
   ...
   [self.vertexBuffer drawArrayWithMode:GL_TRIANGLES
    ...
    /**
     再由第二个纹理设定，同时 vertexBuffer 再次被绘制
        绘图的顺序决定了哪一个纹理会出现在另一个之上
     */
