...
{
    /**
    GLKVector3Normalize 函数的目的是返回一个与矢量 A 方向相同但是大小等于1.0的单位向量，一个矢量的大小是这个矢量的长度，这个长度可以用标准距离公式计算得到(根号)sr(vertorA.x^(2) +vertorA.y^(2) + vertorA.z^(2) )
     */
